...
namespace ARFoundationRemote.Editor {
    public class ARFoundationRemoteInstaller : ScriptableObject {
        ...
        public static void EmbedARFoundation() {
            ...
            Assert.IsFalse(Directory.Exists(to), to); // todo sometimes, after un-embedding the AR Foundation, an empty folder com.unity.xr.arfoundation@x.x.x is left in the Packages folder. Maybe this happens after deleting the folder outside from Unity Editor: in this case, Unity will recreate the deleted folders structure with empty folders
            Copy(from, to);
